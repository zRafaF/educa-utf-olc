...
class UsersStatsRecord:
    def __init__(
        ...
        description=None,
        n_of_articles=None,
        n_of_articles_likes=None,
        n_of_articles_views=None,
        n_of_chapters=None,
        n_of_chapters_likes=None,
        n_of_chapters_views=None,
        username=None,
    ):
        self.avatar = avatar
        self.description = description
...
class TotalUsersArticlesStatsResponse(BaseSystemFields):
    def __init__(
        self, name: str, likes=None, num=None, username=None, views=None, expand=None
    ):
        super().__init__(
            id=None,
            created=None,
